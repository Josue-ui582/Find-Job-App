...
const Search = () => {
  return (
    <div className='searchDiv grid gp-2 bg-greyIsh rounded-[10px] p-[3rem]'>
      <form action="">
        <div className='firstDiv flex justify-between items-center w-100 rounded-8px gap-10 bg-white p-5 shadow-lg shadow-greyIsh-700'>
          ...
          <button className='bg-blueColor h-fill p-5 px-10 rounded-[10px] text-white cursor-pointed hover:bg-blue-300'>Search</button>
        </div>
      </form>
